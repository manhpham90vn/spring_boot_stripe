package com.manhpham.auth.utils.response;

import java.time.Instant;
import java.util.Map;

/**
 * Khuôn lỗi THỐNG NHẤT cho mọi lỗi đã được xử lý (xem GlobalExceptionHandler). Trả lỗi
 * theo một cấu trúc cố định giúp phía client (web/app) parse và hiển thị nhất quán.
 *
